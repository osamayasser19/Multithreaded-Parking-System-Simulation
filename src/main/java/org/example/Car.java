...
public class Car implements Runnable {
    ...
    public void run() {
        try {
            ...
            long waitStartTime = System.nanoTime();// Start waiting here when the car is about to block
            if (!spotAvailable) {
                ...
                long waitTime = (System.nanoTime() - waitStartTime) / 1_000_000_000; // Calculate actual wait time
